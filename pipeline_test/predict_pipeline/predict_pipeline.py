...
class Model_predictor:
    ...
    def predict(self, input_data):
        ...
        print("[...] Diviendo datos de entrada para prediccion")
        ...
        print(f"\t> x_start_station shape: {x_start_station.shape}")
        print(f"\t> x_end_station shape: {x_end_station.shape}")
        
        print("[OK] Datos divididos")
        print("[...] Reallizando prediccion del primer modelo")
        ...
        print(f"\t> Max prob clase 1 extendida: {max_prob_class_1}")
        print(f"\t> ¿Es clase 1? --> {'True' if final_class_1 else 'False'}")
        print("[OK] Prediccion del primer modelo completada")
        
        if final_class_1 == 1:
            print("\t> Se ha predicho 1 viaje")
            return 1
        
        print("[...] Reallizando prediccion del segundo modelo")
        ...
        print("[OK] Prediccion del segundo modelo completada")
        print(f"Se ha predicho {y_pred_int.item()} viajes")
