...
class Normalized_data:
    ...
    def set_input_data(self, input_df: pd.DataFrame):
        ...
        if input_df.empty:
            print(f"{self.character_pre_log}⚠️ Aviso: el DataFrame de entrada está vacío.")

        self.input_data = input_df.copy()
        
        print(f"{self.character_pre_log}[...] Iniciando normalizacion de datos...")
        ...
        print(f"{self.character_pre_log}\t> Añadiendo columna 'event'...")
        if "event" in self.input_data.columns:
            self.output_data ["event"] = self.input_data["event"].values
            
        # Se ordenan las columnas
        print(f"{self.character_pre_log}\t> Ordenando columnas finales...")
        ...
        print(f"{self.character_pre_log}[OK] Normalizacion de datos completado.")
    ...
    def one_hot_encoding(self):
        ...
        """
        print(f"{self.character_pre_log}\t> Realizando one-hot encoding para 'day_type'...")
    ...
    def apply_scalers(self):
        ...
        """
        print(f"{self.character_pre_log}\t> Aplicando scalers a columnas numericas...")
    ...
    def apply_encoders(self):
        ...
        """
        print(f"{self.character_pre_log}\t> Aplicando encoders a columnas categoricas...")
        ...
        for col, encoder in encoder_cols.items():
            if col in df_encoder.columns:
                ...
                print(f"{self.character_pre_log}⚠️ Columna '{col}' no encontrada en input_data. Se omite.")
    ...
    def modify_time_data(self):
        ...
        """
        print(f"{self.character_pre_log}\t> Modificando datos de tiempo a variables ciclicas...")
